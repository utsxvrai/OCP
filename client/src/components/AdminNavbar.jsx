...
function AdminNavbar() {
  ...
  const navItems = [
    ...
    { path: '/admin/complaints', label: 'All Complaints', icon: 'document-text' },
    { path: '/admin/officers', label: 'Manage Officers', icon: 'user-group' },
          ...
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link to="/admin" className="flex items-center">
                <span className="text-primary font-bold text-xl">Admin Portal</span>
              </Link>
            </div>
